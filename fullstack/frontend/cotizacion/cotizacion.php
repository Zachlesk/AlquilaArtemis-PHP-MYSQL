        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-danger" href="../../backend/controllers/empleados/borrarCotizacion.php?id=<?=$val['detalleId'] ?>&&req=delete"> Borrar </a>
                <a class="btn btn-warning" href="../../backend/controllers/empleados/actualizarCotizacion.php?id=<?=$val['detalleId'] ?>"> Editar </a>
              </td>
            </tr>
        ...
        <div class="modal-content" >
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            ...
            <div class="mb-1 col-12">
                <label for="nombreEmpleado" class="form-label"> Cliente </label>
                <input 
                  type="text"
                  id="nombreEmpleado"
                  name="nombreEmpleado"
